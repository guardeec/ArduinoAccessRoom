...
public class Right extends HttpServlet {
    ...
    private final JDBC_Impl.admin.client.security.RightImpl DAO = (JDBC.admin.client.security.Right) appContext.getBean("right");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> message = DAO.log(
                ...
                Boolean.parseBoolean(access_type[0]),
