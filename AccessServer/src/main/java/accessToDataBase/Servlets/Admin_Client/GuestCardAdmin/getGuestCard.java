...
import accessToDataBase.JDBC.Admin.GuestCardAdmin.getGuestCardImpl;
 ...
 */
public class getGuestCard extends HttpServlet {

    private final ApplicationContext appContext = new ClassPathXmlApplicationContext("accessToDataBase/JDBC_config.xml");
    private final getGuestCardImpl guestDB = (getGuestCardImpl) appContext.getBean("getGuestAdmin");
