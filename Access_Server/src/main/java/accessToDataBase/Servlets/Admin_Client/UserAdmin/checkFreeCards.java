...
import accessToDataBase.JDBC.Admin.UserAdmin.checkFreeCardsImpl;
...
public class checkFreeCards extends HttpServlet {
    ...
    private final checkFreeCardsImpl userDB = (checkFreeCardsImpl) appContext.getBean("checkFreeCardsUserAdmin");
