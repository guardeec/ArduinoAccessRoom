    ...
    private class SearchRowMapper implements RowMapper {
        public Object mapRow(ResultSet rs, int i) throws SQLException, SQLException {
            ...
            **value -> stroke map (contains rows)
            ...
            do{
                Map seachStrokeResult = new HashMap<String, String>();

                seachStrokeResult.put("user_id", Integer.toString(rs.getInt("user_id")));
                ...
                if(rs.getMetaData().getColumnCount()>1){
                    seachStrokeResult.put("name", rs.getString("name"));
                    seachStrokeResult.put("role_id", Integer.toString(rs.getInt("role_id")));
                    seachStrokeResult.put("role", rs.getString("role"));
                    seachStrokeResult.put("card", rs.getString("card"));
                    seachStrokeResult.put("state", Boolean.toString(rs.getBoolean("state")));
                }
